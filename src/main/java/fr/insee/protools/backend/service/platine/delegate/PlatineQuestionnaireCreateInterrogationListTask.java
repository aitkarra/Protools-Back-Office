...
public class PlatineQuestionnaireCreateInterrogationListTask implements JavaDelegate, DelegateContextVerifier {
    ...
    public void execute(DelegateExecution execution) {
        ...
        QuestionnaireHelper.createInterrogationsTaskPlatine(execution,protoolsContext,platineQuestionnaireService);
    }
